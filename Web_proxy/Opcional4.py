...
blocked_urls = ["www.blockedurl1.com", "www.blockedurl2.com"]
...
while 1:
 ...
 filetouse = "/" + filename
 fileExist = "false"
 if filename in blocked_urls:
    tcpCliSock.send("HTTP/1.0 403 Forbidden\r\n")
    tcpCliSock.send("Content-Type:text/html\r\n")
    tcpCliSock.send("\r\n")
    tcpCliSock.send("<HTML><TITLE>Forbidden</TITLE></HTML>")
 else:
    try:
...
# python Opcional4.py 192.168.1.1